<?php
// views/service_search_result.php
...
<head>
    <meta charset="UTF-8">
    <title>Search Results | GBVAid </title>
...
<div class="container mt-5">
    ...
    <p class="text-center text-muted mb-4">Browse available services or refine your search by category and brand.</p>
    ...
    <div class="row g-4" id="service-list">
        <!-- AJAX service will populate here -->
    </div>
