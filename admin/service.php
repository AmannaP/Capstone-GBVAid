                ...
                <form id="service-form" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="service_title" name="service_title" class="form-control" placeholder="e.g. Safety Kit" required>
                        </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" id="service_keywords" name="service_keywords" class="form-control" placeholder="comma, separated, tags">
                        </div>

                        <div class="col-md-12">
                            <label class="form-label fw-bold small text-muted">Description</label>
                            <textarea id="service_desc" name="service_desc" class="form-control" rows="4" placeholder="Describe the service ..."></textarea>
                        </div>
                    ...
                    <div class="mt-4 text-end border-top pt-3">
                        ...
                        <button type="submit" id="save-service" class="btn btn-purple px-4"><i class="bi bi-save me-2"></i>Save Service</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="content-card">
            ...
            <div class="p-0">
                <div class="table-responsive">
                    <table class="table table-striped mb-0" id="service-table">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Image</th>
